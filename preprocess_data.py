...
def preprocess(args, input_folders, out_dir, hparams):
	...
	metadata = preprocessor.build_from_path(hparams, input_folders, out_dir, args.n_jobs, tqdm=tqdm)
...
def main():
	...
	parser.add_argument('--language', default='es_ES')
	parser.add_argument('--voice', default='female')
	parser.add_argument('--reader', default='karen_savage')
	parser.add_argument('--merge_books', default='False')
	parser.add_argument('--book', default='angelina')
